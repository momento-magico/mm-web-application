    ...
    return (
        <main className="relative min-h-screen bg-black text-white overflow-hidden">
            ...
            <section className="pt-40 md:pt-60 pb-20 text-center">
                ...
                >
                    Discover the story behind Momento Magico and why we’re shaping the next chapter of progressive music in Asia.
                </motion.p>
            </section>
                ...
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-10 md:p-16 max-w-5xl mx-auto space-y-20 border border-white/10">
                    ...
                    <div>
                        ...
                        <p className="text-white/80 text-lg leading-relaxed font-light">
                            Momento Magico is Sri Lanka’s first immersive music experience dedicated to progressive electronic music.
                            More than a concert, it’s a curated celebration of deep, hypnotic soundscapes that transport you beyond the ordinary.
                            Rooted in passion and built on community, Momento Magico brings together the finest elements of underground culture —
                            music, unity, and artistic freedom.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-white/80 text-lg leading-relaxed font-light">
                            This is your invitation to be part of something truly magical. Momento Magico isn’t just a festival —
                            it’s a signal to the world that Asia is ready to shape the future of progressive music.
                        </p>
                        <p className="mt-6 italic text-white/60">
                            Stay tuned for announcements, behind-the-scenes content, and more as we gear up for something unforgettable.
                        </p>
                    </div>
                </div>
            </section>
