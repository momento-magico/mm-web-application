...
const mainSchema = {
  ...
  event: {
    ...
    description:
      "An electrifying night of progressive music featuring international artists Elline & Backeer, alongside 8 of Sri Lanka's top progressive acts.",
    image: ["https://www.momentomagico.lk/assets/images/events/thamnail.webp"],
    performer: [
      {
